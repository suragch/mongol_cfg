...
const grammarRules = [
  ...
  GrammarRule(CfgSymbol('Place-т'), [CfgSymbol('улаанбаатарт', isTerminal: true)]),
  ...
  GrammarRule(CfgSymbol('Place-аас'), [CfgSymbol('америкаас', isTerminal: true)]),
  ...
  GrammarRule(CfgSymbol('RegularNoun-аар'), [CfgSymbol('машинаар', isTerminal: true)]),
  ...
  GrammarRule(CfgSymbol('RegularNoun-руу'), [CfgSymbol('гол руу', isTerminal: true)]),
  GrammarRule(CfgSymbol('RegularNoun-руу'), [CfgSymbol('дэлгүүр лүү', isTerminal: true)]),
];
